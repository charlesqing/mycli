...
install_requirements = [
    'click >= 7.0',
    'Pygments >= 1.6',
    'prompt_toolkit>=2.0.6,<3.0.0 ; python_version < "3.6"',
    'pip @ git+https://github.com/prompt-toolkit/python-prompt-toolkit.git@7d2ef1998d0eb1ba268e9781be84051f35203b5d ; python_version >= "3.6"',
    'PyMySQL >= 0.9.2',
